...
export const DashboardPage = () => {
  return (
    <div className="dashboard-container p-8 bg-gray-50 text-gray-900 min-h-screen space-y-32">
      ...
      <div className="user-info flex items-center space-x-4 mb-0">
        ...
        <h2 className="user-name text-xl md:text-2xl font-bold text-gray-900">{user.name}</h2>
      </div>
      ...
      <h1 className="text-xl md:text-3xl font-bold mb-4 text-neutral-800">
        ...
        <div className="navigation-buttons space-y-4">
          <Link
            ...
            state={{ from: "/mypage" }}
            className={
              "edit-profile-btn block block text-center font-bold text-gray-900 alien-encounters mb-4 bg-white p-6 rounded-xl shadow-xl hover:bg-gray-300"
            }
          >
            プロフィール編集
          </Link>
