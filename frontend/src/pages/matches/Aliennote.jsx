...
return (
    <div className="matched-screen">
        ...
        <div className="match-input-container p-4 md:p-8 bg-gray-50 text-black min-h-screen space-y-6 md:space-y-32">
            {/* ページのタイトル */}
            <h1 className="text-xl md:text-3xl font-bold mb-4 md:mb-8">遭遇したエイリアン</h1>
            <p className="text-sm md:text-lg">
                今回の交信で遭遇したエイリアンたちです。<br/>タップして詳細を確認してみましょう。
            </p>
            ...
            <p className="text-sm md:text-lg">
                エイリアンたちの情報が記されています。<br/>彼らとの交流に役立ててみましょう。
            </p>
            <div className="background-section mb-4 md:mb-8">
            <h2 className="text-black ml-2 w-full p-2 md:p-4 bg-gray-400 rounded-xl text-center shadow-xl">Coming Soon</h2>
        </div>
        <div className="background-section mb-4 md:mb-8">
            <h2 className="text-gray-50 ml-2 w-full p-2 md:p-4 bg-gray-50 rounded-xl text-center">Coming Soon</h2>
        </div>
        </div>
    </div>
  );
